...
resource "aws_internet_gateway" "terraform_test_internet_gateway" {
  ...
  tags = {
    Name = "dev_terraform_test_internet_gateway"
  }
}
...
resource "aws_route_table" "terraform_public_rt" {
  ...
  tags = {
    Name = "dev_terraform_test_public_route_table"
  }
}
...
resource "aws_subnet" "terraform_public_test_subnet" {
  ...
  tags = {
    Name = "dev_terraform_public_test_subnet"
  }
}
...
resource "aws_subnet" "terraform_private_test_subnet" {
  ...
  tags = {
    Name = "dev_terraform_private_test_subnet"
  }
}
